...
1. Click **Next: Node Pools >** View the options and Accept the default values:

1. Click **Next: Access >** View the options and Accept the default values:

1. Click **Next: Networking >** View the options and Accept the default values:
