...
1. On the **Basics** tab of the **Create Log Analytics workspace** blade, enter the following settings, click **Review + Create**, wait for validation to finish and then click **Create**:
...
1. On the **Create an Automation Account** blade, specify the following settings, and click **Review + Create**, wait for validation to finish and click **Create**:
...
1. In the **Inventory** pane, in the **Log Analytics workspace** drop-down list, select the Log Analytics workspace you created earlier in this task and when the button becomes available, click **Enable**.
...
1. On the Automation account blade, in the **Update Management** section, click **Update management**.

    >**Note**: If you get a warning notification about unsaved edits being discarded, click OK.
...
2. On the **az104-11-vm0 \| Logs** blade, in the **Monitoring** section, click **Metrics**.

3. On the **az104-11-vm0 \| Metrics** blade, on the default chart, note that at this point, the **Metrics Namespace** drop-down list, in addition to the **Virtual Machine Host** entry includes also the **Guest (classic)** entry.
...
4. In the **Metrics Namespace** drop-down list, select  the **Guest (classic)** entry.

5. In the **Metric** drop-down list, review the list of available metrics.

    >**Note**: The list includes additional guest-level metrics not available when relying on the host-level monitoring only.

6. In the **Metric** drop-down list, select **Memory\\Available Bytes**, in the **Aggregation** drop-down list, select **Max**, and review the resulting chart.
...
1. On the **Create alert rule** blade, under the **Condition** Tab, in the **Alert logic** section. Specify the following settings (leave others with their default values)
...
1. On the **Notifications** tab of the **Create an action group** blade, in the **Notification type** drop-down list, select **Email/SMS message/Push/Voice**. In the **Name** text box, type **admin email**.
...
1. When prompted, sign in by using the **Student** username and the ***password*** you provided at deployment.
...
1. Note the number of **Sev 3** alerts and then click the **CPU Percentage** alert link.

    >**Note**: You might need to wait for a few minutes and click **Refresh**.

1. Close the **CPU Percentage above the test threshold** blade.

### Task 7: Review Azure Log Analytics functionality

1. In the Azure portal, navigate back to the **Monitor** blade, click **Logs**.

    >**Note**: You might need to close the **Welcome to Log Analytics** page, if this is the first time you access Log Analytics.
