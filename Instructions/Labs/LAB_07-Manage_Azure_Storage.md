...
1. Minimise the Cloud Shell pane.
...
1. Close the InPrivate mode browser window, return to the browser window showing the **licenses/LICENSE** blade of the Azure Storage container, and select the the **Generate SAS** tab.
...
1. Click **Copy to clipboard** icon next to the **Blob SAS URL** entry.

1. Open another New Incognito (Private) browser window and navigate to the URL you copied in the previous step.

    > **Note**: View the content of the file in the Downloads folder by opening it with Notepad.
...
1. On the Select Members blade, select the name of your user account and click **Select**.

1. Click **Review + Assign** and then **Review + assign**, and return to the **Overview** blade of the **az104-07-container** container.
   
    > **Note**: It can take up to 10 minutes for the change to take effect. Do not wait, proceed to the next task.
...
1. Click **+ File share** On the **Basic** tab of the **New file share** blade enter the following settings:
...
1. Click **Next:Backup>** and **Untick** Enable backup

1. Select **Review + create**, then **Create**.

1. the newly created file share and click **Connect**.
...
1. On the **Firewalls and virtual networks** tab, click the **Enabled from selected virtual networks and IP addresses** option and review the configuration settings that become available once this option is enabled.
...
1. The file will download into the Downloads folder on your machine.
...
1. Leave the Cloud Shell pane open for the next task.
...
1. If not already open from the previous task.  In the Azure portal, open a **PowerShell** session within the **Cloud Shell** pane.
